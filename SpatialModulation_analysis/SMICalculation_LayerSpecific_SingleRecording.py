...
# Example usage (keeps current main behavior, but now minimal)
if __name__ == "__main__":
    # NOTE: replace the path below with the session folder you want to run
    ...
    # Call the wrapped function — keeps the default parameters you've been using.
    Run_SMI_Layer_Analysis(data_filepath)
