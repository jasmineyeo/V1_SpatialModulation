...
__all__ = [
    "get_single_independent_axons", "get_grouped_independent_axons", "get_independent_axons",
    "calculate_speed_per_lap", "reshape_into_laps_forward_only", "process_data_with_speed_filtering", "plot_speed_distribution",
    "nanxcorr", "corr2_coeff",
    "detrendAdaptation",
