...
IF expecting the learning effects (session-drifts), do NOT run this. 
this is to remove the technical session artifact, assuming that the difference you see between 
sessions are due to technical variability
...
FIGURE_DIR = r"D:\V1_SpatialModulation\2p\V1_prism\JSY054_ChronicImaging\PCA\figures\session_correction"
